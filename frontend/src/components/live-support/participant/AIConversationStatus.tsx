...
export function AIConversationStatus({ turnState, onRequestHuman }: AIConversationStatusProps) {
  ...
  return (
    <section aria-live="polite" className="mb-3 rounded-xl border border-cyan-100 bg-cyan-50 px-3 py-2.5 text-xs text-cyan-950">
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          <p className="font-bold text-cyan-950">أنت تتحدث الآن مع مساعد ذكي</p>

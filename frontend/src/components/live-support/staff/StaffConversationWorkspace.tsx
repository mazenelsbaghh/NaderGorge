...
export function StaffConversationWorkspace({ conversation, messages, draft, participantDraft, ownershipLost, pendingAction, messagesLoading, messagesError, onRetryMessages, onDraftChange, onSend, uploading, onUpload, onEditMessage, onDeleteMessage, onTransfer, onClose, cannedReplies, onCannedReply, preferences }: StaffConversationWorkspaceProps) {

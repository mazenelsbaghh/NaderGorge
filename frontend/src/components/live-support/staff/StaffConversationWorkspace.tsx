...
export function StaffConversationWorkspace({ conversation, messages, draft, participantDraft, ownershipLost, pendingAction, messagesLoading, messagesError, onRetryMessages, onDraftChange, onSend, onSendWhatsAppTemplate, uploading, onUpload, onEditMessage, onDeleteMessage, onTransfer, onClose, cannedReplies, onCannedReply, preferences, replyFocusRequest }: StaffConversationWorkspaceProps) {

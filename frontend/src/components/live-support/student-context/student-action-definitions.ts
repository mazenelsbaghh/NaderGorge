...
export const studentActionFields: Record<string, ActionField[]> = {
  ...
  'student.crm.assign': [{ key: 'assignedAgentId', label: 'موظف CRM (اختياري)', type: 'text' }, { key: 'priority', label: 'الأولوية', type: 'select', required: true, options: ['Low', 'Medium', 'High', 'Urgent'] }, { key: 'notes', label: 'ملاحظات', type: 'text' }],

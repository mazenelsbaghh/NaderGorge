          ...
          >
            ...
            {!confirming ? (
              ...
              >
                ...
                <button className="h-11 w-full rounded-xl bg-slate-900 font-semibold text-white">
                  مراجعة وتأكيد
                </button>
              </form>
            ) : (
              <div className="mt-5">
                <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4">
                  <AlertTriangle className="mb-2 text-amber-700" />
                  <h4 className="font-bold">تأكيد التنفيذ</h4>
                  <p className="mt-2 text-sm">
                    سيتم تنفيذ «{selected.labelAr}» على الطالب المرتبط وتسجيل
                    العملية كاملة.
                  </p>
                </div>
                <div className="mt-4 flex gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex h-11 flex-1 items-center justify-center gap-2 rounded-xl bg-red-700 font-semibold text-white"
                  >
                    {busy ? (
            ...
            {result && (
              <p
                role="status"
                className="mt-3 rounded-xl bg-slate-100 p-3 text-sm"
              >
                {result}
              </p>
            )}

...
const date = (value?: string | null) => value ? new Intl.DateTimeFormat('ar-EG-u-nu-latn', { timeZone: 'Africa/Cairo', dateStyle: 'medium' }).format(new Date(value)) : 'بدون انتهاء';

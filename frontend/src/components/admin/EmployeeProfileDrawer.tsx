    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div className="flex max-h-[min(650px,calc(100dvh-2rem))] w-full max-w-lg flex-col overflow-hidden rounded-3xl border border-[var(--admin-border)] bg-[var(--admin-bg)] shadow-2xl">
              {/* Header */}

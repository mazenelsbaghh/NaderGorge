  ...
  return (
    <div className={`flex flex-col items-center justify-center gap-3 ${className}`}>
      ...
      <div className="relative flex items-center justify-center">
        <div className="h-10 w-10 md:h-14 md:w-14 animate-spin rounded-full border-2 border-white/20 border-t-white shadow-[0_0_15px_rgba(255,255,255,0.4)] transition-[color,background-color,border-color,opacity,transform,box-shadow] duration-300 pointer-events-none" />

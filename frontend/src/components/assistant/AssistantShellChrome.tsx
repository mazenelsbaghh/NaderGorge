...
import {
  ...
  KeyRound, ClipboardCheck, AlertTriangle,
} from 'lucide-react';
...
const navItems: AssistantNavItem[] = [
  ...
  { href: '/assistant/recharge-conflicts', label: 'تعارضات الشحن', icon: AlertTriangle, group: 'operations', permission: 'payments.manage' },

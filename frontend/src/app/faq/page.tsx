...
const faqs = [
  ...
  { q: 'إيه المواد المتاحة؟', a: 'حالياً المنصة بتغطي محتوى التاريخ لطلاب الصف الأول والتاني والتالت الثانوي. بيتم إضافة باقات جديدة بشكل دوري من الأستاذ نادر جورج.' },

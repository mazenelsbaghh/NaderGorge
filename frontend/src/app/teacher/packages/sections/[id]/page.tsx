...
export default function TeacherSectionProfilePage(props: { params: Promise<{ id: string }> }) {
  ...
  if (!section) {
    return (
      <AdminShellChrome activePath="/teacher/packages" sectionLabel="إدارة المحتوى" pageTitle="خطأ" subtitle="القسم غير موجود">

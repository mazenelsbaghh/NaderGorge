...
const faqs = [
  ...
  { q: 'أقدر أتفرج على الفيديو كام مرة؟', a: 'كل فيديو ليه عدد مرات مشاهدة محدد بيحددها المُعلم (عادةً 3 مرات). لو خلصت المرات، الفيديو هيتقفل. لو محتاج مرات أكتر، المُعلم يقدر يعمل reset من لوحة التحكم.' },

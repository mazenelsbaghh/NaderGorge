...
export default function AdminAISupportPageClient() {
  ...
  return <AdminPage activePath="/admin/live-support/ai" sectionLabel="خدمة العملاء" pageTitle="المساعد الذكي للدعم" subtitle="حدّد ما يستطيع المساعد قراءته واقتراحه. كل إجراء مؤثر يحتاج إلى تأكيد صاحب المحادثة.">

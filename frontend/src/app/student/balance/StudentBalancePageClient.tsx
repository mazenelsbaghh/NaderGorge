...
export default function StudentBalancePageClient() {
  return (
    <div className="space-y-8 pb-10">
      
      {/* Hero Section */}
      <div className="group relative overflow-hidden rounded-2xl border border-[var(--admin-border)] bg-[var(--admin-card)] p-8 shadow-sm transition-[color,background-color,border-color,opacity,transform,box-shadow] sm:p-10">
        <div className="absolute -left-20 -top-20 h-64 w-64 rounded-full bg-[var(--admin-primary-15)] blur-3xl transition-[color,background-color,border-color,opacity,transform,box-shadow] duration-700 group-hover:scale-150" />
        <div className="absolute -bottom-20 -right-20 h-64 w-64 rounded-full bg-[var(--admin-primary-15)] blur-3xl transition-[color,background-color,border-color,opacity,transform,box-shadow] duration-700 group-hover:scale-150 group-hover:bg-[var(--admin-primary-20)]" />
        ...
        <div className="relative z-10 flex flex-col items-start gap-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="relative flex shrink-0 items-center justify-center">
            ...
            <div className="relative flex h-24 w-24 items-center justify-center rounded-2xl border border-[var(--admin-border)] bg-[var(--admin-card-soft)] shadow-xl backdrop-blur-md rotate-3 transition-transform duration-500 group-hover:rotate-6 group-hover:scale-110">

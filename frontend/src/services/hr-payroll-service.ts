...
export const hrPayrollService = {
  ...
  createComponent: async (payload: { code: string; name: string; classification: PayComponentClass; isTaxable: boolean; isInsurable: boolean }) => (await apiClient.post('/hr/payroll/components', payload)).data,

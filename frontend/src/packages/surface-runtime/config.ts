import { parseSafeReturnUrl } from '@/lib/safe-return-url';
...
export function isValidRedirectUrl(url: string, surface: SurfaceName): boolean {
  return parseSafeReturnUrl(url, surface) !== null;
}

...
test.describe('Admin Content Management Flow', () => {
  ...
  test('T009 & T010: Create Package, Section, Lesson, and Video', async ({ page }) => {
    ...
    await expect(page.locator('text=+ قسم جديد')).toBeVisible({ timeout: 5000 });
    ...
    await expect(page.locator('text=+ درس جديد')).toBeVisible({ timeout: 5000 });

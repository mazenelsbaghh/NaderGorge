# Historical Nader Gorge Database Schema Comparison

This file is retained as a historical generated comparison from before feature
167. It is **not** a current production-health or migration-completion report:
the current model contains later fields and migrations (including outbox lease
and Web Vitals dimensions) that are not represented below. The `Status` column
records the result of that earlier comparison only.

For a current schema decision, run the reviewed
`deploy/production/scripts/audit_database.py` flow against the intended
isolated or production target and retain its timestamped JSON evidence. Do not
infer current synchronization from the check marks in this historical file.
...
| Column Name | C# Type | Database Type | Nullable? | Status |
| --- | --- | --- | --- | --- |
| `AttachmentUrl` | `string` | `character varying(1000)` | `YES` | ✅ Sync |
| `CodeGroupId` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `ConfirmedAt` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `ConfirmedByUserId` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `CreatedAt` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `Id` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `IdempotencyKey` | `string` | `character varying(240)` | `NO` | ✅ Sync |
| `Recipient` | `string` | `character varying(300)` | `NO` | ✅ Sync |
| `UpdatedAt` | `DateTime?` | `timestamp without time zone` | `YES` | ✅ Sync |
...
| Column Name | C# Type | Database Type | Nullable? | Status |
| --- | --- | --- | --- | --- |
| `AgreementId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
| `CodeGroupId` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `CreatedAt` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `Id` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `Recipient` | `string` | `character varying(300)` | `YES` | ✅ Sync |
| `Trigger` | `int` | `integer` | `NO` | ✅ Sync |
| `UpdatedAt` | `DateTime?` | `timestamp without time zone` | `YES` | ✅ Sync |
| `UpdatedByUserId` | `Guid` | `uuid` | `NO` | ✅ Sync |
...
| `CreatedAt` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `DailyBreakAllowanceMinutes` | `int` | `integer` | `NO` | ❌ Missing Column |
| `DailyShortPermissionAllowanceMinutes` | `int` | `integer` | `NO` | ❌ Missing Column |
| `EmployeeNumber` | `string` | `character varying(40)` | `NO` | ✅ Sync |
| `EmploymentStatus` | `int` | `integer` | `NO` | ✅ Sync |
| `HireDate` | `DateOnly` | `date` | `NO` | ✅ Sync |
| `Id` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `ShortPermissionMaxMinutes` | `int` | `integer` | `NO` | ❌ Missing Column |
...
| `Description` | `string` | `character varying(2000)` | `NO` | ✅ Sync |
| `DocumentNumber` | `string` | `character varying(100)` | `NO` | ✅ Sync |
| `Id` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `PaymentReference` | `string` | `character varying(200)` | `YES` | ✅ Sync |
| `Status` | `int` | `integer` | `NO` | ✅ Sync |
| `TeacherId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
| `TeacherSettlementId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
| `Type` | `int` | `integer` | `NO` | ✅ Sync |
| `UpdatedAt` | `DateTime?` | `timestamp without time zone` | `YES` | ✅ Sync |
...
| `CreatedAt` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `CreatedByUserId` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `EffectiveFrom` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `EffectiveTo` | `DateTime?` | `timestamp without time zone` | `YES` | ✅ Sync |
| `Id` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `IsActive` | `bool` | `boolean` | `NO` | ✅ Sync |
| `PriceBasis` | `int` | `integer` | `NO` | ✅ Sync |
| `Reason` | `string` | `character varying(1000)` | `NO` | ✅ Sync |
| `ScopeId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
| `ScopeType` | `int` | `integer` | `NO` | ✅ Sync |
| `TeacherId` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `Trigger` | `int` | `integer` | `NO` | ✅ Sync |
| `UpdatedAt` | `DateTime?` | `timestamp without time zone` | `YES` | ✅ Sync |
| `UpdatedByUserId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
...
| Column Name | C# Type | Database Type | Nullable? | Status |
| --- | --- | --- | --- | --- |
| `AgreementAllocationMode` | `int?` | `integer` | `YES` | ✅ Sync |
| `AgreementId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
| `AgreementScopeId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
| `AgreementScopeType` | `int?` | `integer` | `YES` | ✅ Sync |
| `AllocationMode` | `int` | `integer` | `NO` | ✅ Sync |
| `AllocationValue` | `decimal` | `decimal(18,4)` | `NO` | ✅ Sync |
| `CodeSerialNumber` | `long?` | `bigint` | `YES` | ✅ Sync |
| `ContentNameSnapshot` | `string` | `character varying(300)` | `NO` | ✅ Sync |
| `CreatedAt` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `DiscountBearer` | `int` | `integer` | `NO` | ✅ Sync |
...
| `PriceBasis` | `int?` | `integer` | `YES` | ✅ Sync |
| `ReversedAmount` | `decimal` | `decimal(18,2)` | `NO` | ✅ Sync |
| `ReviewStatus` | `int` | `integer` | `NO` | ✅ Sync |
| `SettlementLineId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
...
| `PaidAmount` | `decimal` | `decimal(18,2)` | `NO` | ✅ Sync |
| `PayoutStatus` | `int` | `integer` | `NO` | ✅ Sync |
| `PlatformDiscountAmount` | `decimal` | `decimal(18,2)` | `NO` | ✅ Sync |
| `PlatformShareAmount` | `decimal` | `decimal(18,2)` | `NO` | ✅ Sync |
| `PromotionalAmount` | `decimal` | `decimal(18,2)` | `NO` | ✅ Sync |
| `ReviewStatus` | `int` | `integer` | `NO` | ✅ Sync |
| `SourceId` | `Guid` | `uuid` | `NO` | ✅ Sync |
...
| `TargetId` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `TargetType` | `int` | `integer` | `NO` | ✅ Sync |
| `TeacherDiscountAmount` | `decimal` | `decimal(18,2)` | `NO` | ✅ Sync |
| `UpdatedAt` | `DateTime?` | `timestamp without time zone` | `YES` | ✅ Sync |
...
| Column Name | C# Type | Database Type | Nullable? | Status |
| --- | --- | --- | --- | --- |
| `AdjustmentId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
| `AllocationId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
| `Amount` | `decimal` | `decimal(18,2)` | `NO` | ✅ Sync |
| `CreatedAt` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `DescriptionSnapshot` | `string` | `character varying(500)` | `NO` | ✅ Sync |
| `Id` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `TeacherSettlementId` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `UpdatedAt` | `DateTime?` | `timestamp without time zone` | `YES` | ✅ Sync |
...
| `CreatedAt` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `Id` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `PaidAt` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `PaidByUserId` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `PaymentMethod` | `string` | `character varying(100)` | `NO` | ✅ Sync |
| `TeacherSettlementId` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `TransferReference` | `string` | `character varying(200)` | `NO` | ✅ Sync |
| `UpdatedAt` | `DateTime?` | `timestamp without time zone` | `YES` | ✅ Sync |
...
| `CreatedByUserId` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `Currency` | `string` | `character varying(3)` | `NO` | ✅ Sync |
| `DebtDeductionAmount` | `decimal` | `decimal(18,2)` | `NO` | ✅ Sync |
| `GrossDueAmount` | `decimal` | `decimal(18,2)` | `NO` | ✅ Sync |
| `Id` | `Guid` | `uuid` | `NO` | ✅ Sync |
| `NetPayableAmount` | `decimal` | `decimal(18,2)` | `NO` | ✅ Sync |
| `Note` | `string` | `character varying(2000)` | `YES` | ✅ Sync |
| `PaidAt` | `DateTime?` | `timestamp without time zone` | `YES` | ✅ Sync |
| `PaidByUserId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
| `PeriodFrom` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `PeriodTo` | `DateTime` | `timestamp without time zone` | `NO` | ✅ Sync |
| `ReviewedAt` | `DateTime?` | `timestamp without time zone` | `YES` | ✅ Sync |
| `ReviewedByUserId` | `Guid?` | `uuid` | `YES` | ✅ Sync |
| `Status` | `int` | `integer` | `NO` | ✅ Sync |
| `TeacherId` | `Guid` | `uuid` | `NO` | ✅ Sync |

...
- [x] Add `VerifyResetFieldsCommand` to authenticate student details via student phone, parent phone (Father/Mother/Secondary parent phone), governorate, and district.

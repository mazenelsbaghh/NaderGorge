...
- Focused finance integration contract suite: 5 passed after the dashboard query translation fix.
- Extended finance suite covers source adapters, expense/refund invariants, budgets, exports, period close, migration checksums, and authorization contracts.

...
CRITICAL = re.compile(r'auth|permission|security|payment|financ|refund|wallet|settlement|migration|appdbcontext|\.csproj$|program\.cs$|/entities/|/configuration|aut[o-]?repair|auto-repair', re.I)
...
def assess_patch(paths: list[str], workspace: Path) -> list[str]:

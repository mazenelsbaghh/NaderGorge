...
public static class PlatformSettingKeys
{
    ...
    public const string SupportWhatsAppUrl = "SupportWhatsAppUrl";
    public const string YouTubeChannelUrl = "YouTubeChannelUrl";
    public const string TelegramChannelUrl = "TelegramChannelUrl";
    public const string MaxActiveDevicesPerStudent = "MaxActiveDevicesPerStudent";
    public const string EnableWatermark = "EnableWatermark";
    public const string WatermarkOpacity = "WatermarkOpacity";
    public const string WatermarkShowBrand = "WatermarkShowBrand";
    public const string WatermarkShowName = "WatermarkShowName";
    public const string WatermarkShowPhone = "WatermarkShowPhone";
    public const string WatermarkShowStudentId = "WatermarkShowStudentId";
    public const string WatermarkShowCustom = "WatermarkShowCustom";
    public const string WatermarkBrandText = "WatermarkBrandText";
    public const string WatermarkCustomText = "WatermarkCustomText";
    public const string WatermarkBrandColor = "WatermarkBrandColor";
    public const string WatermarkNameColor = "WatermarkNameColor";
    public const string WatermarkPhoneColor = "WatermarkPhoneColor";
    public const string WatermarkStudentIdColor = "WatermarkStudentIdColor";
    public const string WatermarkCustomColor = "WatermarkCustomColor";
    public const string WatermarkFontSize = "WatermarkFontSize";
    public const string WatermarkFontWeight = "WatermarkFontWeight";
    public const string WatermarkFontFamily = "WatermarkFontFamily";
    public const string WatermarkPosition = "WatermarkPosition";
    public const string WatermarkMoving = "WatermarkMoving";
    public const string WatermarkIntervalSeconds = "WatermarkIntervalSeconds";
    public const string WatermarkBackgroundColor = "WatermarkBackgroundColor";
    public const string WatermarkBackgroundOpacity = "WatermarkBackgroundOpacity";
    public const string WatermarkTextShadow = "WatermarkTextShadow";

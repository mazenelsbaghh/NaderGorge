...
import { AdminShellChrome, AdminTabBar, AdminTab, AdminStatCard, AdminModal, AdminDataTable, AdminConfirmationDialog } from '@/components/admin';
...
function StudentProfileFrame({ staff, action, children }: { staff: boolean; action: ReactNode; children: ReactNode }) {
  ...
  return <AdminShellChrome activePath="/admin/students" sectionLabel="الطلاب" pageTitle={title} subtitle={subtitle} action={action}>{children}</AdminShellChrome>;
}

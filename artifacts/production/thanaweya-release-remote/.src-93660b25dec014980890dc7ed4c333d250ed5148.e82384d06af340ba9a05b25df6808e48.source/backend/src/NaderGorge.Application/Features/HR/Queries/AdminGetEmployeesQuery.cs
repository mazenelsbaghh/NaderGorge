...
public record EmployeeProfileDto(
    ...
    int DailyBreakAllowanceMinutes,
    int ShortPermissionMaxMinutes,
    int DailyShortPermissionAllowanceMinutes,
    DateTime? UpdatedAt,
    string? RowVersion
);
        ...
        var dtos = profiles
            ...
            .Select(profile => new EmployeeDto(
                ...
                new EmployeeProfileDto(
                    ...
                    profile.StandardStartTime.ToString(@"hh\:mm\:ss"),
                    profile.TargetDailyHours,
                    profile.DailyBreakAllowanceMinutes,
                    profile.ShortPermissionMaxMinutes,
                    profile.DailyShortPermissionAllowanceMinutes,
                    profile.UpdatedAt,

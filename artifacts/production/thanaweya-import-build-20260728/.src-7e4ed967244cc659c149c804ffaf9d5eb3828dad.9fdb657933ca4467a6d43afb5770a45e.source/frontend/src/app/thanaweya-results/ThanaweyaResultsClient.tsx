            ...
            <section aria-live="polite" className="mt-8 border-t border-[var(--landing-line)] pt-7">
              ...
              <div className="mt-7 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl bg-[var(--landing-bg-soft)] p-5">
                  ...
                  <p className="mt-1 text-3xl font-black text-[var(--landing-ink)]">{result.totalDegree ?? '—'}</p>
                </div>
                <div className="rounded-2xl border border-[var(--landing-line)] p-5">
                  <p className="text-sm font-extrabold text-[var(--landing-muted)]">حالة الطالب</p>
                  <p className="mt-3 text-lg font-black leading-7 text-[var(--landing-ink)]">{result.studentCaseDescription || 'لا توجد ملاحظات إضافية'}</p>
                </div>
              </div>
            </section>
          )}

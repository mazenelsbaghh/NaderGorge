...
public sealed record CachedPlatformSettings(
    ...
    bool ParentAppUpdateRequired,
    string ParentAppUpdateUrl,
    string ParentAppUpdateMessage,
    decimal BunnyStreamStorageRateUsdPerGb,
    decimal BunnyStreamBandwidthRateUsdPerGb,
    bool LiveSupportEnabled,
    bool ShowSupportOutsideAccount,
    string GuestSupportWhatsAppNumber,
    ...
    public Task<CachedPlatformSettings> GetAsync(CancellationToken cancellationToken)
    {
        return _memoryCache.GetOrCreateAsync(CacheKey, async entry =>
        {
            ...
            return new CachedPlatformSettings(
                ...
                GetBool(settings, PlatformSettingKeys.ParentAppUpdateRequired, CachedPlatformSettings.Default.ParentAppUpdateRequired),
                GetString(settings, PlatformSettingKeys.ParentAppUpdateUrl, CachedPlatformSettings.Default.ParentAppUpdateUrl),
                GetString(settings, PlatformSettingKeys.ParentAppUpdateMessage, CachedPlatformSettings.Default.ParentAppUpdateMessage),
                ...
                GetBool(settings, PlatformSettingKeys.ShowSupportOutsideAccount, CachedPlatformSettings.Default.ShowSupportOutsideAccount),
                GetString(settings, PlatformSettingKeys.GuestSupportWhatsAppNumber, CachedPlatformSettings.Default.GuestSupportWhatsAppNumber),

...
test "$(
  psql_restore -c \
    'select string_agg("MigrationId",'\'','\'' order by "MigrationId")
     from (select "MigrationId" from "__EFMigrationsHistory"
           order by "MigrationId" desc limit 4) tail;'
)" = \
  "20260726120000_HardenProductionBootstrapData,20260726160804_AlignProductionModel,20260726174622_AddClusterLeases,20260726182136_EnsureSystemRoles"

...
type ActiveTab = 'teacherCenter' | 'payroll' | 'payouts' | 'codes' | 'review';
...
const financeTabs: Array<{
  ...
  { id: 'teacherCenter', label: 'مركز مالية المدرسين', compactLabel: 'مالية المدرسين', Icon: WalletCards },
...
export default function AdminFinancePageClient() {
  const [activeTab, setActiveTab] = useState<ActiveTab>('teacherCenter');
  ...
  return (
    ...
    >
      ...
      {activeTab === 'teacherCenter' && (
        <div id="finance-panel-teacherCenter" role="tabpanel" aria-labelledby="finance-tab-teacherCenter">
